export const NOTION_SECRET =
  import.meta.env.NOTION_SECRET || process.env.NOTION_SECRET
...
export const WAKATIME_API_KEY =
  import.meta.env.WAKATIME_API_KEY || process.env.WAKATIME_API_KEY

export const RANDOM_ENDCODE_VALUE =
  import.meta.env.RANDOM_ENDCODE_VALUE || process.env.RANDOM_ENDCODE_VALUE
